...
import OrderCard from '../components/OrderCard'; // นำเข้า OrderCard component
...
export default function CompletedOrdersScreen({ onReview }) {
  const orders = [
    ...
    },
    {
      ...
      time: '21 Apr , 23.00 pm', // เวลาที่สั่ง
      status: 'Order delivered', // สถานะคำสั่งซื้อ
      imageUrl: require('../assets/logo/นมสดมัชฉะสตอเบอรี่.png'), // รูปภาพของอาหาร
    },
    {
      id: '3',
    ...
    },
    {
      ...
      time: '21 Apr , 23.01 pm', // เวลาที่สั่ง
      status: 'Order delivered', // สถานะคำสั่งซื้อ
      imageUrl: require('../assets/logo/อุด้งผัดซอส.png'), // รูปภาพของอาหาร
    },
    {
      id: '5',
      ...
      status: 'Order delivered', // สถานะคำสั่งซื้อ
      imageUrl: require('../assets/logo/ฮันนี่โทสกล้วยช็อคสตอเบอรี่.png'), // รูปภาพของอาหาร
    },
    {
      id: '6',
      name: '...........', // ชื่ออาหาร
